  ...
  <React.Fragment>
    <section className="contact-search">
      <div className="container">
        <div className="grid">
          <div className="col">
            <center><p className="h3 fw-bold">All Student Data </p></center>
          ...
          <div className="row">
            <div className="col-md-6">
              <form className='row'>
                <div className="col">
                <div className="mb-2">
                  <input type="text" className="form-control" placeholder='Search Student Details' />
                </div>
                </div>
                <div className="col">
                <div className="mb2">
              ...
              <div className="card-body">
                ...
                <div className="col-md-7">
                      ...
                      <li className='list-group-item list-group-item-action'>
                        ...
                        <li className='list-group-item list-group-item-action'>
                            RollNo : <span className='fw-bold'>1</span>
                        </li>

                        <li className='list-group-item list-group-item-action'>
                            Class : <span className='fw-bold'>5th</span>
                        </li>

                        <li className='list-group-item list-group-item-action'>
                            Place : <span className='fw-bold'>Kollam</span>
                        </li>
