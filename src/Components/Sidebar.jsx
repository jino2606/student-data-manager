...
function Sidebar({ children }) {
	...
	/* Function to get the drawer size when closed */
  ...
  useEffect(() => {
    // Access the width of the drawer when it mounts or when open changes
    const width = drawerRef.current ? drawerRef.current.clientWidth : 0;
  ...
  return (
        <>
					...
					<Drawer variant="permanent" position="relative" open={open} ref={drawerRef}>
